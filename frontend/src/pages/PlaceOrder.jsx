            ...
            for(const items in cartItems){
                for(const i in cartItems[items]){
                    if(cartItems[items][i] >0){
                        ...
                        if(itemInfo){
                            itemInfo.size=i;
                            itemInfo.quantity=cartItems[items][i] ;
    ...
    >
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <button
          ...
          className="text-xl text-blue-500 underline mt-1 mb-2 self-end hover:text-blue-800"
        >
          Use Demo Delivery Information
        </button>
      </div>
      {/* ---------------------Right side---------------------- */}
      <div className="mt-8">
        ...
        <div className="mt-12">
          <Title text1={"PAYMENT"} text2={"METHODS"}></Title>
